        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Uncover India's best-kept secrets - tranquil destinations perfect for focused work and authentic cultural experiences.
            </p>
            
            <div className="flex items-center justify-center space-x-2 text-blue-100 mb-8">
              <Gem className="h-5 w-5 text-vintage-gold" />
              <span className="font-semibold">{hiddenGems.length} Hidden Gems</span>
            </div>
          </div>
        </div>
      </section>

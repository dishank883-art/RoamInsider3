...
export default function BudgetCities() {
  const { data: allCities, isLoading } = useQuery({
    queryKey: ['/api/cities']
  });

  // Filter for budget-friendly cities (low cost of living)
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Stretch your budget further in these cost-effective destinations that offer great value without compromising on quality.
            </p>
            
            <div className="flex items-center justify-center space-x-2 text-blue-100 mb-8">
              <IndianRupee className="h-5 w-5 text-vintage-gold" />
              <span className="font-semibold">{budgetCities.length} Budget-Friendly Cities</span>
            </div>
          </div>
        </div>
      </section>
